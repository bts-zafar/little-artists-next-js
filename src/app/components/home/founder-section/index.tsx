                    ...
                    <div className="flex flex-col lg:flex-row gap-10 lg:gap-20 items-center">
                        ...
                        <div className="w-full lg:w-1/2 flex flex-col items-start gap-6">
                            ...
                            <div className="flex items-center py-3 gap-4 md:gap-8 w-full">
                                <span className="bg-primary py-1.5 px-3 text-base font-medium rounded-full">05</span>
                            ...
                            <Link 
                                ...
                                className="group flex items-center gap-2 text-primary hover:text-secondary dark:text-primary transition-colors duration-300 mt-4"
                            >
